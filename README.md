...
**NOTE: If you are using Android 10 and have access problems, please use [this beta version](https://github.com/lfuelling/lrkFM/releases/tag/v2.5.0b2) as long as [Google delays the API due to COVID](https://support.google.com/googleplay/android-developer/answer/9956427?hl=en)**
