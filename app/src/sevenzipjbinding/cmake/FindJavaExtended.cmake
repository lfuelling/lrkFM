...
IF(NOT JAVA_INCLUDE_PATH2)
    MESSAGE("-- Looking for java JNI jni_md.h include path: ${JAVA_INCLUDE_PATH}")
    ...
    ELSE()
        MESSAGE(FATAL_ERROR "Java JNI jni_md.h include file not found at '${JAVA_INCLUDE_PATH}'. ${HELP}")
    ENDIF()
ENDIF()
